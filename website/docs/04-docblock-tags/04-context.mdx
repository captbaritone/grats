...
import ContextDefinition from "!!raw-loader!./snippets/04-context-definition.out";
import ContextUsage from "!!raw-loader!./snippets/04-context-usage.out";
...
<GratsCode out={ContextDefinition} mode="ts" />
...
<GratsCode out={ContextUsage} mode="ts" />
