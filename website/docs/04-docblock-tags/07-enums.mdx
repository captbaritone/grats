...
import EnumTs from "!!raw-loader!./snippets/07-enum-ts.out";
import EnumDeprecated from "!!raw-loader!./snippets/07-enum-deprecated.out";
import EnumStringUnion from "!!raw-loader!./snippets/07-enum-string-union.out";
...
<GratsCode out={EnumTs} mode="both" />
...
<GratsCode out={EnumDeprecated} mode="both" />
...
<GratsCode out={EnumStringUnion} mode="both" />
