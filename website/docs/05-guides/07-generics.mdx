...
_This page is a guide explaining the principles of generic types and showing practical examples of how you might use them. For formal documentation about how generics are supported in Grats see [Generics](../03-resolvers/07-generics.mdx)._
