...
If you want to use a different name for your type in GraphQL than in your code, you can specify the name of the type in the `@gqlType` docblock tag. See [Renaming](../04-renaming.mdx) for more information.
