...
import HeroClass from "!!raw-loader!./snippets/hero-class.out";
import HeroFunctional from "!!raw-loader!./snippets/hero-functional.out";
...
<GratsCode out={HeroClass} mode="ts" />

  </TabItem>
  <TabItem value="fp" label="Functional">

<GratsCode out={HeroFunctional} mode="ts" />
