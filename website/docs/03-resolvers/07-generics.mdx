...
import GenericsBasic from "!!raw-loader!./snippets/07-generics-basic.out";
import GenericsNesting from "!!raw-loader!./snippets/07-generics-nesting.out";
...
<GratsCode out={GenericsBasic} mode="both" />
...
<GratsCode out={GenericsNesting} mode="both" />
