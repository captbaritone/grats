...
// so we define the spec inline as a TypeScript constant.
// The `as any` cast matches the original behavior when importing from JSON.
export const GratsConfigSpec: ConfigSpec = {
