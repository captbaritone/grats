# field_definitions/ParameterPropertyFieldReadOnlyPrivate.invalid.ts
...
```text
  * Applied fix "Make parameter property public" in src/tests/fixtures/field_definitions/ParameterPropertyFieldReadOnlyPrivate.invalid.ts
```
