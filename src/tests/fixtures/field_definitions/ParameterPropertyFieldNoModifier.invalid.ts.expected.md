# field_definitions/ParameterPropertyFieldNoModifier.invalid.ts
...
```text
  * Applied fix "Add 'public' modifier" in src/tests/fixtures/field_definitions/ParameterPropertyFieldNoModifier.invalid.ts
```
