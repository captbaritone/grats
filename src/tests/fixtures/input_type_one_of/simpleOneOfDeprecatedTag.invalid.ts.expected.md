# input_type_one_of/simpleOneOfDeprecatedTag.invalid.ts
...
```text
  * Applied fix "Remove @oneOf tag" in src/tests/fixtures/input_type_one_of/simpleOneOfDeprecatedTag.invalid.ts
```
