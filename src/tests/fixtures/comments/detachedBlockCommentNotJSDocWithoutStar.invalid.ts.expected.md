# comments/detachedBlockCommentNotJSDocWithoutStar.invalid.ts
...
```text
  * Applied fix "Convert to a docblock comment" in src/tests/fixtures/comments/detachedBlockCommentNotJSDocWithoutStar.invalid.ts
```
