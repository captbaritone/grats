# typename/PropertySignatureTypenameIncorrectName.invalid.ts
...
```text
  * Applied fix "Create Grats-compatible `__typename` type" in src/tests/fixtures/typename/PropertySignatureTypenameIncorrectName.invalid.ts
```
