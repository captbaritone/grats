# typename/PropertyTypenameNonStringInitializer.invalid.ts
...
```text
  * Applied fix "Create Grats-compatible `__typename` property" in src/tests/fixtures/typename/PropertyTypenameNonStringInitializer.invalid.ts
```
