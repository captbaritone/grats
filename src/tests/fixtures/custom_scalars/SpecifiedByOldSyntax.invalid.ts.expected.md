# custom_scalars/SpecifiedByOldSyntax.invalid.ts
...
```text
  * Applied fix "Replace @specifiedBy with @gqlAnnotate" in src/tests/fixtures/custom_scalars/SpecifiedByOldSyntax.invalid.ts
```
