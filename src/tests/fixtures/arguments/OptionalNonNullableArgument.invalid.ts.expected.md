# arguments/OptionalNonNullableArgument.invalid.ts

## Input

```ts title="arguments/OptionalNonNullableArgument.invalid.ts"
/** @gqlType */
...
```text
  * Applied fix "Add '| null' to the type" in src/tests/fixtures/arguments/OptionalNonNullableArgument.invalid.ts
```
