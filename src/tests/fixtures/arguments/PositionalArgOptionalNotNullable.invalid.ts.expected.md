# arguments/PositionalArgOptionalNotNullable.invalid.ts
...
```text
  * Applied fix "Add '| null' to the parameter type" in src/tests/fixtures/arguments/PositionalArgOptionalNotNullable.invalid.ts
```
