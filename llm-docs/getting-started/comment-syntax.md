...
> **INFO:**
> To learn more about _why_ Grats uses docblock comments, see the page [Why Use Comments](../faq/why-use-comments.md).
...
— [JSDoc Documentation](https://jsdoc.app/about-getting-started)
...
See [Descriptions](../resolvers/descriptions.md) for more information about descriptions.
