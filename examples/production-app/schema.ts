 ...
 */
import { defaultFieldResolver, GraphQLSchema, GraphQLObjectType, GraphQLInt, GraphQLList, GraphQLNonNull, GraphQLString, GraphQLScalarType, GraphQLID, GraphQLInterfaceType, GraphQLBoolean, GraphQLInputObjectType } from "graphql";
            ...
            return {
                ...
                likes: {
                    ...
                    resolve(source, args, _context, info) {
                        return assertNonNull(source.likes(args, info));
                    }
                },
                publishedAt: {
        ...
        fields() {
            return {
                ...
                nodes: {
                    ...
                    resolve(source) {
                        return assertNonNull(postConnectionNodesResolver(source));
                    }
                },
                pageInfo: {
                    name: "pageInfo",
        ...
        fields() {
            return {
                ...
                posts: {
                    ...
                    resolve(source, args, _context, info) {
                        return assertNonNull(source.posts(args, info));
                    }
                }
            };
        },
        ...
        fields() {
            return {
                ...
                nodes: {
                    ...
                    resolve(source) {
                        return assertNonNull(likeConnectionNodesResolver(source));
                    }
                },
                pageInfo: {
                    name: "pageInfo",
        ...
        fields() {
            return {
                ...
                nodes: {
                    ...
                    resolve(source) {
                        return assertNonNull(userConnectionNodesResolver(source));
                    }
                },
                pageInfo: {
                    name: "pageInfo",
            ...
            return {
                feed: {
                    ...
                    resolve(source, _args, context) {
                        return assertNonNull(source.feed(context));
                    }
                },
                user: {
                    ...
                    type: UserType,
                    resolve(source, _args, context) {
                        return assertNonNull(source.user(context));
                    }
                }
            };
        }
        ...
        fields() {
            return {
                likes: {
                    ...
                    resolve(source, args, context, info) {
                        return assertNonNull(queryLikesResolver(source, args, context, info));
                    }
                },
                node: {
                ...
                nodes: {
                    ...
                    resolve(source, args, context) {
                        return assertNonNull(queryNodesResolver(source, args, context));
                    }
                },
                posts: {
                    ...
                    resolve(source, args, context, info) {
                        return assertNonNull(queryPostsResolver(source, args, context, info));
                    }
                },
                users: {
                    ...
                    resolve(source, args, context, info) {
                        return assertNonNull(queryUsersResolver(source, args, context, info));
                    }
                },
                viewer: {
                    description: "The currently authenticated viewer.",
        ...
        fields() {
            return {
                createLike: {
                    ...
                    resolve(source, args, context) {
                        return assertNonNull(mutationCreateLikeResolver(source, args.input, context));
                    }
                },
                createPost: {
                    ...
                    resolve(source, args, context) {
                        return assertNonNull(mutationCreatePostResolver(source, args.input, context));
                    }
                },
                createUser: {
                    ...
                    resolve(source, args, context) {
                        return assertNonNull(mutationCreateUserResolver(source, args.input, context));
                    }
                }
            };
        }
